...
- [Request parameters](/api/monitor-chatgpt) - Configure your content generation requests
- [Response structure](/api/response-structure) - Understand the output format
