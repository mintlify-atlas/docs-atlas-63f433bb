...
- [Shopping cards structure](/api-reference/response-structure#shopping-cards) - Detailed schema documentation
- [Request parameters](/api-reference/parameters) - Configure your monitoring requests
