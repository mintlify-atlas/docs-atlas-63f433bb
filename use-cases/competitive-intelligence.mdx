...
- [Request parameters](/api/monitor-chatgpt) - Configure monitoring requests
- [Query fan-out insights](/api/monitor-chatgpt#search-queries) - Understand ChatGPT's research process
- [Shopping cards](/api/response-structure#shopping-cards) - Track product visibility
