...
- [Request parameters](/api-reference/parameters) - Configure advanced research options
- [Response structure](/api-reference/response-structure) - Understand the data schema
- [Credit usage](/api-reference/credits) - Plan your research budget
